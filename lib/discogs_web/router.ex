defmodule DiscogsWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {DiscogsWeb.LayoutView, :root}
  ...
  scope "/", DiscogsWeb do
    ...
    resources "/formats", FormatController, only: [:index]
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: DiscogsWeb.Telemetry
    end
  end
